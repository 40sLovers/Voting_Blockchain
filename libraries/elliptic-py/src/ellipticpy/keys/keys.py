...
from ..curves.curves import NIST192p, find_curve
from ..utils.util import string_to_number, number_to_string, randrange
from ..utils.util import sigencode_string, sigdecode_string
from ..utils.util import oid_ecPublicKey, encoded_oid_ecPublicKey
...
class VerifyingKey:
    ...
    @classmethod
    def from_public_point(klass, point, curve=NIST192p, hashfunc=sha256):
    ...
    @classmethod
    def from_string(klass, string, curve=NIST192p, hashfunc=sha256,
                    validate_point=True):
        order = curve.order
        ...
        from ..curves import ellipticcurve
...
class SigningKey:
    ...
    @classmethod
    def generate(klass, curve=NIST192p, entropy=None, hashfunc=sha256):
        secexp = randrange(curve.order, entropy)
        return klass.from_secret(secexp, curve, hashfunc)
    ...
    @classmethod
    def from_secret(klass, secexp, curve=NIST192p, hashfunc=sha256):
        self = klass(_error__please_use_generate=True)
        self.curve = curve
        self.default_hashfunc = hashfunc
    ...
    @classmethod
    def from_PEM(klass, string, hashfunc=sha256):
    ...
    @classmethod
    def from_DER(klass, string, hashfunc=sha256):
    ...
    def sign(self, data, entropy=None, hashfunc=None, sigencode=sigencode_string, k=None):
        """
        hashfunc= should behave like hashlib.sha256 . The output length of the
        ...
        Use hashfunc=hashlib.sha256 to match openssl's -ecdsa-with-sha256 mode,
